...
export const TestimonialTheme02: React.FC<
    Props & {
        id?: string
    }
            ...
            <div className="flex flex-wrap -m-4">
                {testimonials && (
                    testimonials.map((testimonial: any, index: number) => {
                        ...
                        return (
                            <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center" key={index}>
                                ...
                                <p className="leading-relaxed text-lg">{testimonial.quote}</p>
