...
export const TestimonialTheme05: React.FC<
    Props & {
        id?: string
    }
                        ...
                        return (
                            <div className="p-4 md:w-1/2 w-full" key={index}>
                                <div className="h-full bg-gray-100 dark:bg-gray-700 p-8 rounded">
                                    ...
                                    <p className="leading-relaxed mb-6 dark:text-white/80">
                                        {testimonial.quote}
                                    </p>
                                    <a className="inline-flex items-center">
                                        ...
                                        <span className="flex-grow flex flex-col pl-4">
                                            <span className="title-font font-medium text-gray-900 dark:text-gray-100">{testimonial.name}</span>
                                            <span className="text-gray-500 dark:text-gray-200 text-sm">{testimonial.position}</span>
                                        </span>
                                    </a>
                                </div>
                            </div>
