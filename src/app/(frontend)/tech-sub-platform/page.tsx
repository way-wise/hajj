        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
            <a href="https://github.com/way-wise" target="_blank" rel="noopener noreferrer" className="block">
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                    ...
                    <h3 className="text-xl text-black dark:text-white font-semibold text-center mb-2">GitHub</h3>
            ...
            <Link href="/project-management" className="block">
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                    ...
                    <h3 className="text-xl text-black dark:text-white font-semibold text-center mb-2">Upwork Contracts</h3>
            ...
            <a href="https://bids.waywisetech.com/admin" target="_blank" rel="noopener noreferrer" className="block">
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                    <div className="flex items-center justify-center mb-4">
                        <svg className="w-12 h-12 text-gray-800 dark:text-white" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <h3 className="text-xl text-black dark:text-white font-semibold text-center mb-2">Upwork Bids</h3>
            ...
            <Link href="https://jobs.waywisetech.com/" target="_blank" className="block">
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                    <div className="flex items-center justify-center mb-4">
                        <svg className="w-12 h-12 text-gray-800 dark:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <h3 className="text-xl text-black dark:text-white font-semibold text-center mb-2">Local Jobs</h3>
