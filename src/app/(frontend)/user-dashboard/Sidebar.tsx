    ...
    return (
        <div className='w-1/4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-lg mt-16'>
            <div className='flex justify-center items-center -mt-16'>
                <img className='w-32 h-32 rounded-full object-cover' src="https://images.pexels.com/photos/614810/pexels-photo-614810.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" />
            </div>
            <div className='p-5'>
                ...
                <a href="" className='bg-main-primary px-5 py-2.5 rounded-lg text-white inline-flex justify-start items-center gap-2'>
                    <span>Logout</span>
