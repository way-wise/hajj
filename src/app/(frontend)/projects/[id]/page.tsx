            ...
            <div>
              ...
              <div className="mt-4 text-sm text-gray-600">
                <p className="mb-2">
                  ...
                  <span className={`px-2 py-1 rounded-md ${getStatusStyle(project.status)}`}>
                    {project.status}
                  </span>
                </p>
                <p className="mb-2">
          ...
          <div className="p-6 my-6 rounded-lg border border-gray-100 shadow-sm">
            ...
            <ul className="mt-4 grid gap-4 md:grid-cols-2">
              {project?.projectFeatures.map((item: any, index: number) => (
                <li
                  key={index}
                  className="flex items-center justify-between space-x-3 p-4 border border-gray-200 rounded-lg shadow hover:bg-gray-50"
                >
