    ...
    <div className="container mx-auto p-4">
            ...
            {messages.length === 0 ? (
              ...
              messages.map((message) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`w-full max-w-[70%] ${isCurrentUserReceiver ? 'items-end' : 'items-start'}`}
                    >
                      <div
                        className={`flex items-center gap-2 mb-1 ${isCurrentUserReceiver ? 'justify-end' : 'justify-start'}`}
                      >
      ...
      <form onSubmit={handleSubmit} className="bg-white p-4 rounded-lg border shadow-sm">
        <div className="grid grid-cols-2 gap-4 mb-4">
          ...
          <div>
            <Input type="file" onChange={handleFileChange} disabled={sending} className="text-sm" />
          </div>
        </div>
        <div className="mb-4">
          <Textarea
