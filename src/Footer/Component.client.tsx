...
export const FooterClient: React.FC<{ footer: FooterType | null | undefined }> = ({ footer }) => {
  ...
  return (
    ...
    >
      ...
      <div className="container">
        ...
        <div className="py-8">
          <p className="text-center text-base text-white dark:text-white text-shadow-sm shadow-black">
      ...
      <div className="absolute right-0 top-14 z-[-1]">
        ...
        >
          <circle opacity="0.1" cx="49.5" cy="49.5" r="49.5" fill="#4A6CF7" />
          <mask
            id="mask0_94:899"
          ...
          <g mask="url(#mask0_94:899)">
            ...
            <g opacity="0.3" filter="url(#filter0_f_94:899)">
