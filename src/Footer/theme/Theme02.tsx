      ...
      <div className="container">
        <div className="footer-top pb-14 grid grid-cols-2 gap-5 md:grid-cols-4 pt-10">
          ...
          <div className="flex-grow col-span-full md:col-span-1">
            <h3 className="widget-title mb-3 text-base-600 text-white">Subscribe to our blog</h3>
            <ul>
              <li>
                <form
                  action="https://jobflix.templatecookie.com/subscribe"
                  method="POST"
                ...
                >
                  <input
                    type="hidden"
                    name="_token"
                    value="LX7ZxIad6FThbCthYkZzy1zXD638AU1kbL93kxlW"
                    autoComplete="off"
                  />
                  <div className="w-full flex items-center gap-3 px-[18px] rounded-lg border border-white/40 shadow-gray-base-1 hover:border-secondary-500 focus-within:border-secondary-500 transition duration-200 ease-linear">
                    ...
                    <input
                      ...
                      className="w-full bg-transparent placeholder:text-white/40 text-white border-0 outline-none focus:ring-0 py-[10px]"
                    />
                  </div>
                  <button type="submit" className="bg-rose-500 px-5 py-2 rounded-lg text-white">
                    {' '}
                    Subscribe{' '}
                  </button>
                </form>
        ...
        <div className="footer-bottom py-3 flex gap-4 flex-wrap-reverse justify-center items-center border-t border-white/10">
          <div className="flex-grow">
            <p className="body-base-400 text-white/40 flex justify-center">{footer?.copyright}</p>
          </div>
        </div>
      </div>
    </footer>
