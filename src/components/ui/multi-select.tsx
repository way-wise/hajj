...
>(({ className, children, ...props }, ref) => {
  const { value, options, onValueChange, activeIndex } = useMultiSelect();
...
>(({ className, value, children, ...props }, ref) => {
  const { value: OptionValues, onValueChange, setInputValue } = useMultiSelect();
  ...
  const isIncluded = OptionValues.includes(value);
  return (
    <CommandItem
      ref={ref}
      {...props}
