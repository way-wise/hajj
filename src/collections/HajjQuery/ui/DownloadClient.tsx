...
const DownloadClient = ({ data }: { data: any }) => {
  return (
    <div style={{ marginTop:'30px', width: '100%', display: 'flex', flexDirection: 'row-reverse', gap: '40px', justifyContent: 'center' }}>
          ...
          <div className="header">
            <div className="logo-container">
              ...
              <div className="company-info">
                ...
                <div className="subtitle"><span>An American and Bangladeshi Joint Venture</span></div>
              </div>
          ...
          <div className="footer">
            ...
            <div className="contact-info">
              <span style={{width: '40%', flexBasis: 'min-content'}}>
                <img src="/assets/home.png" className="icon" alt='homeIcon' /> House: B/148(5th Floor), <br />{' '}
                Road: 22, Mohakhali, Dhaka- 1212
              </span>
              <span style={{width: '30%'}}>
